...
parser = argparse.ArgumentParser(description="bioz_REx")
...
parser.add_argument("--sel_sessions", type=str2list, default="06,07")
...
flags.test_index = min(flags.test_index, len(envs) - 1)
print(
    f"# of batches=={num_batches}; batch_size={flags.batch_size}; min_length={train_min_length}"
)
print("-".join(["-" for i in range(35)]))
# initialize wandb
print("line 139 == " + envs[flags.test_index]["fname"])
if flags.use_wandb:
    import wandb
