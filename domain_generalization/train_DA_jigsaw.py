...
def get_args():
    ...
    parser.add_argument(
        "--random_horiz_flip", default=0.0, help="Chance of random horizontal flip"
    )
    ...
    parser.add_argument(
        "--target_weight", type=float, default=0, help="Weight for target jigsaw task"
    )
    parser.add_argument(
        "--entropy_weight", type=float, default=0, help="Weight for target entropy"
    )
    ...
    parser.add_argument(
        "--TTA", type=bool, default=False, help="Activate test time data augmentation"
    )
    parser.add_argument(
        "--classify_only_sane",
        default=False,
